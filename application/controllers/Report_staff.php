...
class Report_staff extends CI_Controller {
	...
	{	
		...
		$reportData = $this->staff_report->query_staff_salary($return["storeid"], $return["querydate"], $return["queryenddate"]);
		$return["reportData"]=$reportData;
	...
	public function salary_detail($staffid)
	{
		...
		$return["queryend"] = $query_enddate;
	   	...
	   	$reportData = $this->staff_report->query_staff_salary_detail($staffid, $return["querydate"],$return["queryend"]);
	...
	public function salary_month_detail($staffid)
	{
		...
		$querydate = $this->input->get('querydate');
	   	...
	   	$reportData = $this->staff_report->query_staff_salary_month_detail($staffid, $return["querydate"]);
	...
	{	
		...
		$reportData = $this->staff_report->query_staff_salary_month($return["storeid"], $return["querydate"], $return["queryenddate"]);
		$return["reportData"]=$reportData;
