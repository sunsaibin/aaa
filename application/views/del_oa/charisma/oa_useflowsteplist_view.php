    ...
    <?php 
        if (isset($query)) {
            foreach ($query as $key => $value) {
                ...
                echo '<a class="btn btn-success" href="'.site_url("del_oa/oa_list_form?id=".$value->lufs_id."&tid=".$value->lufs_userflow).'"><i class="glyphicon glyphicon-zoom-in icon-white"></i>查看表单</a>';
                //echo "&nbsp;&nbsp;&nbsp;&nbsp;";
