                ...
                <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                    ...
                    if (isset($query)) {
                        foreach ($query as $key => $value) {
                            ...
                            echo '<a class="btn btn-success" href="'.site_url("flow_own/own_approval_form/".$storeid."?tid=".$value->luf_id.'&id='.$value->lfuff_userflow).'"><i class="glyphicon glyphicon-zoom-in icon-white"></i>查看表单</a>';
                            //echo "&nbsp;&nbsp;&nbsp;&nbsp;";
