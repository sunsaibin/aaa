<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-flag"></i> 审批步骤列表</h2>
    ...
    <?php 
        if (isset($query)) {
            foreach ($query as $key => $value) {
                echo '<tr>';
                echo '<td class="center" style="width: 80px;">'.$value->flow_id.'</td>';
                echo '<td class="center">'.$value->flow_name.'</td>';
                echo '<td class="center">'.$value->flow_company.'</td>';
                echo '<td class="center" style="width: 180px;">'.$value->flow_cdate.'</td>';
                ...
                echo '<a class="btn btn-success" href="#"><i class="glyphicon glyphicon-zoom-in icon-white"></i>查看</a>';
                echo "&nbsp;&nbsp;&nbsp;&nbsp;";
                echo '<a class="btn btn-info" href="'.site_url("flow_block/flow_edit/".$value->flow_id).'"><i class="glyphicon glyphicon-edit icon-white"></i>编辑</a>';
                    ...
                    <div class="container-fluid">
                        <form class="form-horizontal" id="newFlow" action="<?php echo site_url("form/form/from/tem");?>">
                            <div class="form-group ">
                                <label for="sName" class="col-xs-3 control-label">子流程名称：</label>
                                <div class="col-xs-8 ">
