	...
	?>
		<div class="enrty-com container" id="printDetail">
			...
			<div class="content">
				...
				<div class="item2">
					<div class="inline">原门店：<span><?php echo $storenum_old->STORESHORTNUM.'-'.$array["crossStoreTransfer_staff_store_name_old"]; ?></span></div>
					<div class="inline posi1">新门店：<span><?php echo $storenum_new->STORESHORTNUM.'-'.$array["crossStoreTransfer_staff_store_name_new"]; ?></span></div>
				</div>
				<div class="item2">
					<div class="inline">员工姓名：<span><?php echo $array["crossStoreTransfer_staff_staffnumber_old"].$array["crossStoreTransfer_staff_staffname"]; ?></span></div>
					<div class="inline posi1">手机号码：<span><?php echo $staffinfo->PHONE; ?></span></div>
				</div>
				<div class="item2">
					<div class="inline">原员工工号：<span><?php echo $array["crossStoreTransfer_staff_staffnumber_old"]; ?></span></div>
					<div class="inline posi2">原职位：<span>
					<?php
						foreach ($companyrank as $k => $v) {
						  	if($array["crossStoreTransfer_staff_rankid_old"] == $v->option_key){
						  		echo $v->option_value;
						  	}
						}  				 
					?>
				...
				<div class="item2">
					<div class="inline">新员工工号：<span><?php echo $array["crossStoreTransfer_staff_staffnumber_new"]; ?></span></div>
					<div class="inline posi3">新职位：<span>
					<?php
						foreach ($companyrank as $k => $v) {
						  	if($array["crossStoreTransfer_staff_rankid_new"] == $v->option_key){
						  		echo $v->option_value;
						  	}
						}  				 
					?>
				...
				<div class="item2">
					<div class="inline">调动前工资：<span><?php echo $array["crossStoreTransfer_staff_basesalary_old"]; ?></span></div>
					<div class="inline posi4">调动后工资：<span><?php echo $array["crossStoreTransfer_staff_basesalary_new"]; ?></span></div>
				</div>
