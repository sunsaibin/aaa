		...
		<div class="enrty-com container" id="printDetail">
			...
			<div class="content">
				<div class="item2">
					...
					<div class="inline posi1">申请门店：<span><?php echo $storenum->STORESHORTNUM.'-'.$array["entryAppli_staff_store_name_old"]; ?></span></div>
				</div>
				<div class="item2">身份证号码：<span><?php echo $array["entryAppli_staff_idcard"]; ?></span></div>
				<div class="item2">
					<div class="inline">员工工号：<span><?php echo $array["entryAppli_staff_staffnumber"].$array["entryAppli_staff_staffname"]; ?></span></div>
					<div class="inline posi2">手机号码：<span><?php echo $array["entryAppli_staff_phone"]; ?></span></div>
				</div>
				<div class="item2">
					<div class="inline">入职门店：<span><?php echo $storenum->STORESHORTNUM.'-'.$array["entryAppli_staff_store_name_old"]; ?></span></div>
					<div class="inline posi3">入职职位：<span>

					<?php
						foreach ($companyrank as $k => $v) {
						  	if($array["entryAppli_staff_rankid"] == $v->option_key){
						  		echo $v->option_value;
						  	}
						}  				 
					?>
				...
				<div class="item2">员工薪资：<span><?php echo $array["entryAppli_staff_basesalary"]; ?></span></div>
				<div class="item2">入职日期：<span><?php echo $array["dmdate_entryAppli_staff_change_date"]; ?></span></div>
