		...
		<div class="quit container" id="printDetail">
			...
			<div class="content">
				<div class="item">
					...
					<div class="inline posi1">申请门店：<span><?php echo $storenum->STORESHORTNUM.'-'.$array["salaryAdjustment_staff_store_name_old"]; ?></span></div>
				</div>
				<div class="item">身份证号码：<span><?php echo $staffinfo->IDCARD; ?></span></div>
				<div class="item">
					<div class="inline">员工工号：<span><?php echo $array["salaryAdjustment_staff_staffnumber_old"].$array["salaryAdjustment_staff_staffname"]; ?></span></div>
					<div class="inline posi2">手机号码：<span><?php echo $staffinfo->PHONE; ?></span></div>
				</div>
				<div class="item">
					<div class="inline">调整前薪资：<span><?php echo $array["salaryAdjustment_staff_basesalary_old"]; ?></span></div>
					<div class="inline posi3">调整后薪资：<span><?php echo $array["salaryAdjustment_staff_basesalary_new"]; ?></span></div>
				</div>
