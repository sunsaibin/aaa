    ...
    default:
        ...
        break;
               ...
               /* echo '<td class="center" style="width: 80px;">'.$value->luf_id.'</td>';*/
                ...
                echo '<a class="btn btn-success" href="'.site_url("oa/oa_user_flowstep?id=".
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form class="form-horizontal from-hr" method="POST" id="form1" action="<?php echo site_url("oa/oa_user_flowform");?>/">
