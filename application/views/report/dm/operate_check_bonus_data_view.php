...
<div class="container-sum">
    <div class="container-top">
        ...
        <label class="form-check-label">
            <input type="text" class="form-check-input" id="staff_number" value="<?php  echo $staff_number; ?>">
            员工编号
        </label>
...
<script type="text/javascript">
    function  submitDmForm(str_id){
        ...
        var seach_staff_number_val = $("#staff_number").val();
        if(seach_staff_number_val.length<1) {
            $.AlertDialog.CreateAlert("警告", "请输入员工编号!");
        }
    ...
    function request_data(){
        ...
        $.post("<?php echo site_url(); ?>/operate_check/bonus_check_data_data",
            { seach_name: seach_name_val, start_date: start_date_val,end_date: end_date_val , choose_type: choose_type_val, seach_storeid: seach_storeid_val, seach_companyid: seach_companyid_val,seach_staff_number:seach_staff_number_val},
            function(data){
                console.debug(data);
...
<script>
    var dm_table_header =  ['日期','公司编号','门店编号','员工名称','员工编号','员工PTYPEID','员工RANKID','卡号','支付名称','支付编码','业务类型','type','detailtype','总金额','员工业绩','员工提出比例','员工提出金额','售卡提成'];
    $(document).ready(function () {
        ...
        $("#table_list_1").jqGrid({
            ...
            //rowList: [10, 20, 30],
            colNames:dm_table_header,
            colModel: [
                {name:'col1',index: 'col1', width: 150},
                {name:'col2',index:'col2',width:100,align:"right"},
                {name:'col3',index:'col3',resizable:false,align:"right",width:130},
                {name:'col4',index:'col4',resizable:false,align:"right",width:130},
                {name:'col5',index:'col5',resizable:false,align:"right",width:130},
                {name:'col6',index:'col6',resizable:false,align:"right",width:130},
                ...
                {name:'col11',index:'col11',resizable:false,align:"right",width:130},
                ...
                {name:'col18',index:'col18',resizable:false,align:"right",width:130}
            ],
            viewrecords: true,
        });
...
<script>
    function export_dmExcel(tableId)
    {
        ...
        var tableHeader = dm_table_header;
...
<form id="export_form_id" name="export_form" action='<?php echo site_url(); ?>/operate_check/bonus_check_data_data' method="post"  target="_blank" >
