...
<div class="container-sum">
    <div class="container-top">
        ...
        <div class="inputd-group report-radio">
            ...
            <button type="button" class="btn btn-primary" onclick="javascript:window.open('<?php echo site_url(); ?>/staff_report/staff_period_month_old_report','_blank')";">
            <img src="<?php echo base_url(); ?>/jslibs/report/content/images/oldversion_icon.svg" alt="search">
            <span>旧版本-2</span>
            </button>
        </div>
...
<script type="text/javascript">
    ...
    function request_data(){
        ...
        $.post("<?php echo site_url(); ?>/staff_report/staff_period_month_report_data",
...
<script>
    $(document).ready(function () {
        ...
        $("#table_list_1").jqGrid({
            ...
            //rowList: [10, 20, 30],
            colNames: ['日期/员工名称','门店','虚业绩(含卡)','销卡大项业绩','销卡小项业绩','现金大项业绩','现金大项提成','现金小项业绩','现金小项提成','现金卖品业绩','现金卖品提成','销卡大项提成','销卡小项提成','销卡卖品业绩','销卡卖品提成','现金项目业绩','售卡业绩','售卡提成','疗程业绩','疗程提成','经理签单业绩','经理签单提成','退卡业绩','退卡提成','服务业绩','提成总额'],
            colModel: [
...
<script>
    function export_dmExcel(tableId)
    {
        ...
        var tableHeader = ['日期/员工名称','门店','虚业绩(含卡)','销卡大项业绩','销卡小项业绩','现金大项业绩','现金大项提成','现金小项业绩','现金小项提成','现金卖品业绩','现金卖品提成','销卡大项提成','销卡小项提成','销卡卖品业绩','销卡卖品提成','现金项目业绩','售卡业绩','售卡提成','疗程业绩','疗程提成','经理签单业绩','经理签单提成','退卡业绩','退卡提成','服务业绩','提成总额'];
