...
<script type="text/javascript">
    ...
    function request_data(){
        ...
        $.post("<?php echo site_url(); ?>/store_cashier/store_period_classify_report_data_new",
    ...
    function submitDmForm_checkcard()
    {
        ...
        $.post("<?php echo site_url(); ?>/store_cashier/store_period_classify_report_checkcard_new", {seach_name: seach_name_val, start_date: start_date_val,end_date: end_date_val , choose_type: choose_type_val, seach_storeid: seach_storeid_val, seach_companyid: seach_companyid_val}, function(data){
            //console.debug(data);
            var json_data = eval("("+data+")"); ;
            gcarddata=json_data;
            if(json_data.data != null){
                ...
                layer.open({
                   ...
                   area: ['900px', '500px'],
                   content: '<?php echo site_url(); ?>/store_cashier/store_period_classify_report_cardwindow_new'
                });
            }else{
