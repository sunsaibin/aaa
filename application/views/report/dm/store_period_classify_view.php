...
<script type="text/javascript">
    ...
    function request_data(){
        ...
        $.post("<?php echo site_url(); ?>/store_report/store_period_classify_report_data",
...
<script>
    var dm_table_header =  ['日期/门店',"  (虚业绩)  ", ' (美容虚业绩) ',
        ' (美发虚业绩) ',' (美甲虚业绩) ',' (美容/美发/美甲) ',
        '(实业绩)','(实业绩)','(实业绩)','(实业绩)',
        '(美容/美发/美甲)', '总的售卡业绩', '美容售卡业绩','美发售卡业绩','美甲售卡业绩',
        '(美容 / 美发 / 美甲)'];
    $(document).ready(function () {
        ...
        $("#table_list_1").jqGrid({
            ...
            colModel: [
                {name:'col1',index: 'col1', width: 150, frozen:true},
                ...
                {name:'col16',index:'col16',resizable:false,align:"right",width:130}
            ],
            viewrecords: true,
        });
        ...
        $("#table_list_1").jqGrid('setGroupHeaders', {
            ...
            groupHeaders:[
                ...
                {startColumnName: 'col6', numberOfColumns: 1, titleText: '虚业绩占比'},
                {startColumnName: 'col7', numberOfColumns: 1, titleText: '总服务业绩'},
                {startColumnName: 'col8', numberOfColumns: 1, titleText: '美容服务业绩'},
                {startColumnName: 'col9', numberOfColumns: 1, titleText: '美发服务业绩'},
                {startColumnName: 'col10', numberOfColumns: 1, titleText: '美甲服务业绩'},
                {startColumnName: 'col11', numberOfColumns: 1, titleText: '服务业绩占比'},
                {startColumnName: 'col16', numberOfColumns: 1, titleText: '售卡业绩占比'}
            ]
        });
...
<script>
    function export_dmExcel(tableId)
    {
        ...
        var tableHeader =  ['日期/门店',"  总现金业绩(虚业绩)  ", '美容现金业绩(美容虚业绩) ',
            '美发现金业绩(美发虚业绩) ','美甲现金业绩(美甲虚业绩) ','虚业绩占比(美容/美发/美甲) ',
            '总服务业绩(实业绩)','美容服务业绩(实业绩)','美发服务业绩(实业绩)','美甲服务业绩(实业绩)',
            '服务业绩占比(美容/美发/美甲)', '总的售卡业绩', '美容售卡业绩','美发售卡业绩','美甲售卡业绩',
            '售卡业绩占比(美容 / 美发 / 美甲)'];
