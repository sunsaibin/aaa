$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            //$('#bs-css').attr('href', '../../jslibs/charisma/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            //$('#bs-css').attr('href', '../../jslibs/charisma/css/bootstrap-' + themeName + '.min.css');
        }
    ...
    $('#is-ajax').prop('checked', $.cookie('is-ajax') === 'true' ? false : false);
